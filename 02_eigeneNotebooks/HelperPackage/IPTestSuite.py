...
benchList.append(Benchmark("Trap", CollisionChecker(trapField), [[9,15]], [[3,9],[19,8],[3,3],[20,15],[10,1]], description, 1))
...
benchList.append(Benchmark("Fat bottleneck", CollisionChecker(fatBottleNeckField), [[4,21]], [[18,4],[4,4],[18,16],[18,1]], description, 3))
...
benchList.append(Benchmark("B_rush",CollisionChecker(simpleField),[[1,17.7]],[[10,10],[15,2],[20,18],[17.25,10]], description,4))
...
description = "Find the path"
benchList.append(Benchmark("Circle of Death", CollisionChecker(draw), [mid],[[10,4.5],[10,7.5],[20,3],[1,1]], description, 5))